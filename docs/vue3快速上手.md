...
<div style="border:1px solid black;width:410px;float:left;margin-right:20px;">
<strong>vue2.x的生命周期</strong>
<img src="https://cn.vuejs.org/images/lifecycle.png" alt="lifecycle_2" style="zoom:33%;width:1200px" />
</div>
<div style="border:1px solid black;width:530px;height:1026px;float:left">
...
<div style="width:350px;height:370px;overflow:hidden;float:left">
